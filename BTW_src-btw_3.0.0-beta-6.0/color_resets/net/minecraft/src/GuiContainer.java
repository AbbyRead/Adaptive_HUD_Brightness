...
// ---END EDIT---
    ...
    {
        if ((par2 == 1 || par2 == this.mc.gameSettings.keyBindInventory.keyCode) && !EmiScreenManager.search.isFocused())
        {
...
// +++START EDIT+++
    ...
    private boolean drawSlotSpecialItems(Slot slot, ItemStack stack)
    {
        if ( stack != null )
        {
            if (stack.getItem().getIconFromDamage(0) instanceof CustomUpdatingTexture customUpdateTexture)
            {
