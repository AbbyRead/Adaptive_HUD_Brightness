...
// +++START EDIT+++
        if (par2ItemStack.getItemSpriteNumber() == 0 && par2ItemStack.itemID < Block.blocksList.length &&Block.blocksList[par2ItemStack.itemID] != null && Block.blocksList[par2ItemStack.itemID].doesItemRenderAsBlock(par2ItemStack.getItemDamage()))
// ---END EDIT---
        {
        ...
        {
            Icon var5 = CITUtils.getIcon(par1EntityLivingBase.getItemIcon(par2ItemStack, par3), par2ItemStack, par3);
            ...
            if (!CITUtils.renderEnchantmentHeld(par2ItemStack, par3) && par2ItemStack.hasEffect() && par3 == 0)
            {
...
// +++START EDIT+++
                ...
                else if ( var22 == EnumAction.miscUse )
                {
                    ...
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos(var23 / 4.0F * (float)Math.PI) * 0.1F) *
                        (( var8.getMaxItemUseDuration() - var3.getItemInUseCount() ) >= var8.getItem().getItemUseWarmupDuration() ? 1F : 0F), 0.0F);
...
// +++START EDIT+++
            ...
            if (var8.getItem().getIconFromDamage(0) instanceof CustomUpdatingTexture customUpdateTexture)
            {
