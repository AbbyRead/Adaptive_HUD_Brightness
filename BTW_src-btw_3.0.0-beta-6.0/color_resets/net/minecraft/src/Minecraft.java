...
// ---END EDIT---
    ...
    private boolean didDifficultyCheck = false;
    ...
    {
// +++START EDIT+++
        MCPatcherUtils.setMinecraft((File)null, (File)null, "1.6.4", "5.0.3");
// ---END EDIT---
		theMinecraft = this;
...
// ---END EDIT---
    ...
    private void startGame() throws LWJGLException
    {
		...
		if (!this.fullscreen || !this.gameSettings.borderlessFullscreen) {
...
// +++START EDIT+++
        //TexturePackChangeHandler.afterChange0();
        //TexturePackChangeHandler.beforeChange1();
// ---END EDIT---
...
// ---END EDIT---
    ...
    public void refreshResources()
    {
        ...
        if (this.theWorld == null || !this.theWorld.getDifficulty().isRestricted()) {
...
// ---END EDIT---
        ...
        {
			if (!this.gameSettings.borderlessFullscreen) {
                this.toggleFullscreen();
            }
			else {
				this.setIngameNotInFocus();
...
// ---END EDIT---
    ...
    public void refreshFullscreen()
    {
        try
        {
            ...
            {
                if (this.gameSettings.borderlessFullscreen) {
                    // Set to borderless windowed mode by using desktop resolution without exclusive fullscreen
                    System.setProperty("org.lwjgl.opengl.Window.undecorated", "true");
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (!this.theWorld.getDifficulty().isRestricted()) {
            ...
            while (this.gameSettings.keyBindAchievements.isPressed()) {
                displayGuiScreen(new GuiAchievements(statFileWriter));
            }
...
// ---END EDIT---
    ...
    public void launchIntegratedServer(String par1Str, String par2Str, WorldSettings par3WorldSettings)
    {
        ...
        if ((var5 != null && var5.getDifficulty().isRestricted()) || (par3WorldSettings != null && par3WorldSettings.getDifficulty().isRestricted())) {
            if (!AddonHandler.isLockedAllowed()) {
                return;
            }
        }
        ...
        this.loadingScreen.displaySavingString(I18n.getString("menu.loadingLevel"));
        ...
        while (!this.theIntegratedServer.serverIsInRunLoop())
        {
            ...
            if (var6 != null)
            {
                this.loadingScreen.displayLoadingString(I18n.getString(var6));
            }
            else
            {
    ...
    public void loadWorld(WorldClient par1WorldClient, String par2Str)
    {
        ...
        if (par1WorldClient == null)
        {
            ...
            if (this.theIntegratedServer != null)
            {
                ...
                long time = getSystemTime() + 10000L;
                while (!this.theIntegratedServer.isServerStopped() && getSystemTime() < time && !this.running) {
                    try {
                        Thread.sleep(100L);
                    }
                ...
                if (!this.theIntegratedServer.isServerStopped() && !this.running) {
                    System.out.println("Warning: The integrated server didn't shut down after 10 seconds!");
                }
            }
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper par1PlayerUsageSnooper)
    {
        ...
        par1PlayerUsageSnooper.addData("run_time", Long.valueOf((MinecraftServer.getCurrentTimeMillis() - par1PlayerUsageSnooper.func_130105_g()) / 60L * 1000L));
...
// +++START EDIT+++
    ...
    public void launchIntegratedServerHostile(String par1Str, String par2Str, WorldSettings par3WorldSettings)
    {
        ...
        // Copy seed of global hostile world
        if (par3WorldSettings != null) {
            ISaveHandler var4 = this.saveLoader.getSaveLoader2(par1Str, false);
            WorldInfo worldInfo = var4.loadWorldInfo();
            if (worldInfo != null) {
                long seed = worldInfo.getSeed();
                par3WorldSettings = new WorldSettings(seed, par3WorldSettings.getGameType(), par3WorldSettings.isMapFeaturesEnabled(), par3WorldSettings.getHardcoreEnabled(), par3WorldSettings.getTerrainType(), par3WorldSettings.getDifficulty(), par3WorldSettings.isDifficultyLocked());
            }
        }
        // Start dummy server
        this.launchIntegratedServer(par1Str, par2Str, par3WorldSettings);
        try
        {
            Thread.sleep(1L);
        }
        ...
        if (par3WorldSettings != null)
        {
            var5 = new WorldInfo(par3WorldSettings, par1Str, true);
            try {
                WorldInfo wi = var4.loadWorldInfo();
                if (wi != null && wi.getTerrainType() != WorldType.DEFAULT) {
                    // Delete world
                    var4.flush();
                    File world = new File(new File(MCPatcherUtils.getDefaultGameDir().getParentFile(), ".minecraft-saves"), "world");
                    SaveFormatOld.deleteFiles(world.listFiles());
                }
        ...
        {
            var5 = var4.loadWorldInfo();
        }
        
        if (par3WorldSettings == null)
        {
            par3WorldSettings = new WorldSettings(var5);
            par3WorldSettings.disableCommands();
        }
        ...
        // Intentional
        // this.loadingScreen.displaySavingString(I18n.getString("menu.loadingLevel"));
        this.loadingScreen.displayLoadingString(I18n.getString("menu.loadingLevel"));
    ...
    public void setDidDifficultyCheck(boolean value) {
        this.didDifficultyCheck = value;
    }
    
    public boolean didDifficultyCheck() {
        return this.didDifficultyCheck;
	}
    // ---END EDIT---
}
